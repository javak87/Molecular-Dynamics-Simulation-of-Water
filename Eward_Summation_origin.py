...
[docs]    def compute_partial_energy(self, removed_indices):
        """
...
[docs]    def compute_sub_structure(self, sub_structure, tol=1e-3):
        """
...
[docs]    def get_site_energy(self, site_index):
...
[docs]    def add_m_list(self, matrix_sum, m_list):
        """
...
[docs]    def best_case(self, matrix, m_list, indices_left):
        """
...
[docs]    def get_next_index(self, matrix, manipulation, indices_left):
        """
...
[docs]def compute_average_oxidation_state(site):
    """
