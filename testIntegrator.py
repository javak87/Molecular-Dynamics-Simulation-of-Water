...
def integrator_test():
    ...
    postate, all_velocities = Integrator(postate, all_velocities, lj_force_periodic, timespan, mass)

    print(postate)
    print(all_velocities)

    postate, all_velocities = Integrator(postate, all_velocities, lj_force_naive, timespan, mass)
